...
using Autofac;
using Your.ProjectName.Core.ContributorAggregate;
using Your.ProjectName.Core.Interfaces;
using Your.ProjectName.Infrastructure.Data;
using Your.ProjectName.Infrastructure.Data.Queries;
using Your.ProjectName.Infrastructure.Email;
using Your.ProjectName.UseCases.Contributors.Create;
using Your.ProjectName.UseCases.Contributors.List;
using MediatR;
using MediatR.Pipeline;
using Module = Autofac.Module;

namespace Your.ProjectName.Infrastructure;
